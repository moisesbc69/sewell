...
class Reservation(JSONResponseMixin, View):
    ...
    def post(self, request):
        ...
        if not form.is_valid():
            return self.render(request,{'success': False,
        ...
        return self.render(request,{"reservation": reservation_dict,
    ...
    def delete(self, request):
        ...
        return self.render(request,{"reservation_day": ReservationDay.objects.get(id=reservation_day.id),
    ...
    def get(self, request):
        ...
        return self.render(request,{"reservations": reservations_dict,
                                        "error": None})
...
class MonthDetailView(JSONResponseMixin, View):
    ...
    def get(self, request, month, year):
        ...
        reservation_days = ReservationDay.objects.filter(
            date__gte=date_from,
            date__lte=date_to)
        return self.render(request,reservation_days)
...
def calendar_view(request):
    ...
    return render(request, "calendar.html", {'defaults': defaults, 'form_details': form_details})
